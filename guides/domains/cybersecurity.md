...
| **GLM-5.3-Flash** | GLM-5.3의 경량 파생(2026-08-25), 텍스트+이미지 입력, MIT. 새 아키텍처(`glm5_next`)라 **2026-09-26 기준 llama.cpp 지원 PR(#27752 등)이 미병합**이며, GGUF가 먼저 올라왔지만 PR 빌드 없이는 로드되지 않을 수 있다 | UD-Q2_K_XL 약 108.7 GB, UD-IQ4_XS 약 156.8 GB, UD-Q4_K_XL 약 199.7 GB | Q2 192 GB(128 GB는 빠듯), IQ4 192–256 GB, Q4 256 GB | [공식](https://huggingface.co/zai-org/GLM-5.3-Flash) · [unsloth GGUF](https://huggingface.co/unsloth/GLM-5.3-Flash-GGUF) · 백엔드 병합 후 재확인 |
